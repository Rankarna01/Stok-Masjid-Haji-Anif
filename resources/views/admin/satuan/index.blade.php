    ...
    <div class="overflow-x-auto rounded-xl border border-border">
        <table class="w-full text-sm text-left">
            ...
            <tbody class="divide-y divide-border">
                <template x-for="item in items" :key="item.id_satuan">
                    <tr class="hover:bg-gray-50/50 transition-smooth">
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex justify-center gap-2">
                                ...
                                <button @click="deleteData(item.id_satuan)" class="p-1.5 text-danger hover:bg-danger/10 rounded-lg transition-smooth border border-transparent hover:border-danger/20">
