...
@section('content')
<div class="w-full max-w-5xl bg-card rounded-3xl card-shadow border border-border flex overflow-hidden">
    
    <!-- Left Side: Lottie Animation -->
    <div class="hidden md:flex md:w-1/2 bg-primary/5 items-center justify-center p-8 relative">
